package com.legend.vo.user;

import com.legend.bo.user.AbstractUserBO;
import com.legend.model.contant.Regex.Regexp;
...
import com.legend.model.group.user.UpdatePasswordGroup;
import com.legend.vo.AbstractVO;
 ...
 * @date 2018/2/17
 */
public class AbstractUserVO extends AbstractVO<AbstractUserVO, AbstractUserBO> {
    ...
    @Override
    protected void parseProcess(AbstractUserVO abstractUserVO) {
